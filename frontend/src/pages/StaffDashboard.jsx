    ...
    <div className="staff-dashboard">
      ...
      <aside className="staff-dashboard__sidebar">
        ...
        <nav className="staff-dashboard__nav">
          ...
          {canAccess('canViewDeliveries') && (
            <button
              className={`staff-dashboard__nav-item ${activeMenu === 'deliveries' ? 'staff-dashboard__nav-item--active' : ''}`}
          ...
          {canAccess('canViewPayments') && (
            <button
              className={`staff-dashboard__nav-item ${activeMenu === 'payments' ? 'staff-dashboard__nav-item--active' : ''}`}
          ...
          {canAccess('canViewOrderHistory') && (
            <button
              className={`staff-dashboard__nav-item ${activeMenu === 'order-history' ? 'staff-dashboard__nav-item--active' : ''}`}
          ...
          {canAccess('canViewMarginAnalysis') && (
            <button
              className={`staff-dashboard__nav-item ${activeMenu === 'margin-analysis' ? 'staff-dashboard__nav-item--active' : ''}`}
