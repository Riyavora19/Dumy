    ...
    <div className="admin">
      ...
      <aside className="admin__sidebar">
        ...
        <nav className="admin__nav">
          ...
          <button 
            className={`admin__nav-item ${activeMenu === 'stock' ? 'admin__nav-item--active' : ''}`}
          ...
          <button 
            className={`admin__nav-item ${activeMenu === 'deliveries' ? 'admin__nav-item--active' : ''}`}
          ...
          <button 
            className={`admin__nav-item ${activeMenu === 'payments' ? 'admin__nav-item--active' : ''}`}
          ...
          <button 
            className={`admin__nav-item ${activeMenu === 'order-history' ? 'admin__nav-item--active' : ''}`}
