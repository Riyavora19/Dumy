...
const AdminQuotationSettings = () => {
  ...
  const handleUpload = async (e) => {
    ...
    setUploading(true);
    try {
      const response = await fetch('http://localhost:5000/api/quotation-settings/upload-logo', {
        method: 'POST',
        body: formData
      });
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`http://localhost:5000/api/quotation-settings/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleActivate = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/quotation-settings/activate/${id}`, {
        method: 'PUT'
      });
  ...
  const handlePermanentDelete = async (id) => {
    try {
      const response = await fetch(`http://localhost:5000/api/quotation-settings/permanent/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleDragEnd = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/quotation-settings/reorder', {
        method: 'PUT',
        headers: {
